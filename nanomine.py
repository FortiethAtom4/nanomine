...
parser.add_argument("-s","--slots",choices=[f"{i}" for i in range(1,10)],help="Number of picks in hotbar")
...
match args.pickaxe:
    ...
    case "diamond":
        ...
        mine_duration = 0.5
    case "netherite": #please don't waste your netherite on automining cobblestone
...
for i in range (slots):
    print(f"Mining with pickaxe {i + 1}...")
